...
export namespace DisplacementFeature {
     ...
     * `onBeforeCompile` callback of that material. It adds the required code to the shaders and
     * declares the new uniforms that control fading based on view distance.
     *
    ...
    export function onBeforeRender(
        ...
        // TODO: Check if map changed before setting uniform??
        if (
